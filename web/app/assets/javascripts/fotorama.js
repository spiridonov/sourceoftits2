...
(function ($) {
  ...
  var csstrFLAG = Mdrnzr.csstransforms && Mdrnzr.csstransitions;
  ...
  function doFotorama(fotorama, o) {
    ...
    function getRatioWidthHeight(forceResize) {
      ...
      //   if (wrapHeight > windowHeight - 20 - (!o().vertical && thumbsSize2 ? thumbsSize2 : 0)) {
          wrapHeight = windowHeight - o().verticalMargin - (!o().vertical && thumbsSize2 ? thumbsSize2 : 0);
          wrapRatio = wrapWidth / wrapHeight;
      //   }
      // }
    }
